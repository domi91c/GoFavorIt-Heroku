class WallsController < ApplicationController
  ...
  def create
	  ...
	  @wall.build_gallery
	  @pictures = @wall.gallery.pictures
  ...
  private
    ...
    def wall_params
      params.require(:wall).permit(:bio, :user_id, gallery_attributes: [:id, :name, :description, :wall_id]).merge(user_id: current_user.id)
    end
end
